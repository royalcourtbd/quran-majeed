...
import 'package:quran_majeed/presentation/memorization/widgets/memorize_ayah_continer_top_row.dart';
...
class MemorizationAyahContainer extends StatelessWidget {
  final int index;
  final int surahID;
  ...
  const MemorizationAyahContainer({
    super.key,
    required this.index,
