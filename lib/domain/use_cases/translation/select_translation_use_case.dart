...
class SelectTranslationUseCase extends BaseUseCase<void> {
  SelectTranslationUseCase(this._translationRepository, super.errorMessageHandler);

  final TranslationRepository _translationRepository;

  Future<Either<String, void>> execute({required TTDbFileModel file}) {
    return mapResultToEither(() => _translationRepository.selectTranslation(file: file));
  }
}